  ...
  <style>
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    .rss-link {{ display: inline-flex; align-items: center; gap: 0.4rem;
                  color: var(--purple-mid); font-size: 0.82rem; text-decoration: none; margin-top: 1rem; }}
...
<main>
  ...
  <div style="display:flex;gap:1.5rem;align-items:center;flex-wrap:wrap;margin-top:1rem">
    <a href="feed.xml" class="rss-link" style="margin-top:0">
    ...
    <a href="https://www.notion.so/{NOTION_DATABASE_ID}" target="_blank" class="rss-link" style="margin-top:0">
      <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
